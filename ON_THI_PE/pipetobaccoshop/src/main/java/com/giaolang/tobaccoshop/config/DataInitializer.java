...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (accountRepo.count() == 0) {
            accountRepo.save(new Account(null, "admin", "123", "ADMIN"));
            accountRepo.save(new Account(null, "user", "123", "USER"));
        }
        ...
        if (productRepo.count() == 0) {
            ...
            productRepo.saveAll(Arrays.asList(
                    ...
                    new Product(null, "Mac Baren HH Old Dark Fired", 330000,
                            ...
                            getCatByName("Thuốc Đan Mạch"), true),
